...
Five things a reader might want, and where each of them is. Nothing here is generated —
...
| [`DRTMLE`](drtmle/) | the one variant still in progress: the theorem concordance, the validation plan, the investigation log, and the external review that started it |
