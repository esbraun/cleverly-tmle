...
| `variable_importance` | none. It raises the fold-policy refusal first, then asks the hook on each candidate's prepared data, and it refuses before the first fit |
