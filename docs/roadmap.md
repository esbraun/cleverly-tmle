...
| Validation | V7 | Fold-evaluated CV-TMLE comparator | source audit | V6 ordering only | [V7](#v7-fold-evaluated-cv-tmle-comparator) |
| Validation | V8 | Selector-based multi-arm C-TMLE comparator | source audit | V7 ordering only | [V8](#v8-selector-based-multi-arm-c-tmle-comparator) |
...
### V7. Fold-evaluated CV-TMLE comparator
...
### V8. Selector-based multi-arm C-TMLE comparator
