...
| [cross-fitted end-of-study longitudinal TMLE](method-evidence.md#cross-fitted-end-of-study-longitudinal-tmle) | one exact five-fold assignment, held-out recursion checks, independent theory properties, and the rejected R `lmtp` interval audit |
...
| [cross-fitted survival-curve longitudinal TMLE](method-evidence.md#cross-fitted-survival-curve-longitudinal-tmle) | one exact five-fold assignment across both horizons, held-out and survivor-only controls, and independent theory properties |
