...
| Longitudinal survival and competing risks | [Event-process TMLE](longitudinal-tmle.md#survival-and-competing-risks); Stitelman et al. (2012) | [`longitudinal/estimator.py`](https://github.com/esbraun/cleverly-tmle/blob/main/src/cleverly/longitudinal/estimator.py) | R `ltmle` 1.3-0 for ordinary survival; pinned `lmtp` 1.5.4 for the cross-fitted survival row; no competing-risk parity claim | gated [ordinary](method-evidence/ordinary-survival-curve-longitudinal-tmle.md) and [cross-fitted](method-evidence/cross-fitted-survival-curve-longitudinal-tmle.md) survival studies, plus survival and competing-risk rows in [longitudinal evidence](evidence.md#longitudinal-estimands-outside-the-target-registry) |
