...
| Known stochastic regimes | [Known regimes](point-treatment-tmle.md#known-regimes); Díaz & van der Laan (2013) | [`interventions/base.py`](https://github.com/esbraun/cleverly-tmle/blob/main/src/cleverly/interventions/base.py), [`estimators/tmle.py`](https://github.com/esbraun/cleverly-tmle/blob/main/src/cleverly/estimators/tmle.py) | no maintained external comparator claimed | gated [stochastic-regime study](method-evidence/stochastic-point-treatment-regimes.md), including density replacement and targeting controls |
...
| Incremental propensity-score interventions | [Incremental interventions](point-treatment-tmle.md#incremental-propensity-score-interventions); Kennedy (2019) | [`interventions/incremental.py`](https://github.com/esbraun/cleverly-tmle/blob/main/src/cleverly/interventions/incremental.py), [`estimators/tmle.py`](https://github.com/esbraun/cleverly-tmle/blob/main/src/cleverly/estimators/tmle.py) | pinned R `imtp` 0.1.0 at `d4b5204` as a point-estimate witness only | gated [incremental-intervention study](method-evidence/incremental-propensity-interventions.md), plus [`ey_ipsi`, `ate_ipsi`](evidence.md#the-table), including nonzero treatment-score and one-sided remainder witnesses |
