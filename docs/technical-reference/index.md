...
| Cross-fitting and CV-TMLE | [CV-TMLE and cross-fitting](cv-tmle.md); Zheng & van der Laan (2011), Levy (2018), Chernozhukov et al. (2018) | [`learners/crossfit.py`](https://github.com/esbraun/cleverly-tmle/blob/main/src/cleverly/learners/crossfit.py) | pinned `tmle3` stacked validation likelihood and `sl3` fold/full prediction source; no parity implementation for the complete repeat rule | gated [stacked CV-TMLE](method-evidence/stacked-point-treatment-cv-tmle.md), [fold-evaluated CV-TMLE](method-evidence/fold-evaluated-point-treatment-cv-tmle.md), and reporting-policy [repeated CV-TMLE](method-evidence/repeated-cross-fitting.md) rows, plus leakage and repeated-fold mutations |
