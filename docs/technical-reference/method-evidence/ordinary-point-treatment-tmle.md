...
| --- | --- | --- | ---: | ---: | --- | ---: | --- | ---: | --- | --- |
| cleverly | `ey1` | identity | -0.000144 [-0.0016, 0.0013] | ±0.0056 | Pass | 0.9425 [0.9258, 0.9565] | Pass | 0.9861 [0.9402, 1.0370] | Pass | Pass |
| cleverly | `ey0` | identity | 0.000593 [-0.000802, 0.0020] | ±0.0054 | Pass | 0.9531 [0.9378, 0.9657] | Pass | 1.0102 [0.9659, 1.0587] | Pass | Pass |
| cleverly | `ate` | identity | -0.000737 [-0.0026, 0.0012] | ±0.0074 | Pass | 0.9494 [0.9336, 0.9624] | Pass | 1.0067 [0.9611, 1.0570] | Pass | Pass |
| cleverly | `att` | identity | -0.000833 [-0.0028, 0.0012] | ±0.0077 | Pass | 0.9506 [0.9350, 0.9635] | Pass | 1.0088 [0.9627, 1.0591] | Pass | Pass |
| cleverly | `atc` | identity | -0.000635 [-0.0026, 0.0013] | ±0.0076 | Pass | 0.9506 [0.9350, 0.9635] | Pass | 0.9997 [0.9548, 1.0489] | Pass | Pass |
| cleverly | `ey_obs` | identity | 0.000168 [-0.000858, 0.0012] | ±0.0040 | Pass | 0.9450 [0.9286, 0.9586] | Pass | 0.9919 [0.9497, 1.0382] | Pass | Pass |
| cleverly | `par` | identity | -0.000425 [-0.0014, 0.000586] | ±0.0039 | Pass | 0.9469 [0.9307, 0.9603] | Pass | 1.0082 [0.9639, 1.0574] | Pass | Pass |
| cleverly | `paf` | identity | -0.000817 [-0.0030, 0.0013] | ±0.0084 | Pass | 0.9494 [0.9336, 0.9624] | Pass | 1.0118 [0.9673, 1.0614] | Pass | Pass |
| cleverly | `rr` | log | -0.000975 [-0.0053, 0.0033] | ±0.0167 | Pass | 0.9556 [0.9406, 0.9678] | Pass | 1.0117 [0.9665, 1.0599] | Pass | Pass |
| cleverly | `or` | log | -0.0015 [-0.0095, 0.0064] | ±0.0309 | Pass | 0.9500 [0.9343, 0.9630] | Pass | 1.0074 [0.9610, 1.0565] | Pass | Pass |
| tmle3 | `ey1` | identity | -0.000144 [-0.0016, 0.0013] | ±0.0056 | Pass | 0.9425 [0.9258, 0.9565] | Pass | 0.9861 [0.9411, 1.0348] | Pass | Pass |
| tmle3 | `ey0` | identity | 0.000593 [-0.000802, 0.0020] | ±0.0054 | Pass | 0.9531 [0.9378, 0.9657] | Pass | 1.0101 [0.9654, 1.0606] | Pass | Pass |
| tmle3 | `ate` | identity | -0.000736 [-0.0026, 0.0012] | ±0.0074 | Pass | 0.9487 [0.9328, 0.9619] | Pass | 1.0066 [0.9615, 1.0560] | Pass | Pass |
| tmle3 | `att` | identity | -0.000811 [-0.0028, 0.0012] | ±0.0077 | Pass | 0.9500 [0.9343, 0.9630] | Pass | 1.0141 [0.9691, 1.0649] | Pass | Pass |
| tmle3 | `atc` | identity | -0.000658 [-0.0026, 0.0013] | ±0.0076 | Pass | 0.9544 [0.9392, 0.9668] | Pass | 1.0049 [0.9611, 1.0555] | Pass | Pass |
| tmle3 | `ey_obs` | identity | 0.000168 [-0.000858, 0.0012] | ±0.0040 | Pass | 0.9450 [0.9286, 0.9586] | Pass | 0.9919 [0.9500, 1.0407] | Pass | Pass |
| tmle3 | `par` | identity | -0.000424 [-0.0014, 0.000587] | ±0.0039 | Pass | 0.9469 [0.9307, 0.9603] | Pass | 1.0081 [0.9634, 1.0576] | Pass | Pass |
| tmle3 | `paf` | negative_log_complement | -0.000138 [-0.0029, 0.0026] | ±0.0105 | Pass | 0.9487 [0.9328, 0.9619] | Pass | 1.0114 [0.9671, 1.0600] | Pass | Pass |
| tmle3 | `rr` | log | -0.000974 [-0.0053, 0.0033] | ±0.0167 | Pass | 0.9556 [0.9406, 0.9678] | Pass | 1.0116 [0.9677, 1.0614] | Pass | Pass |
| tmle3 | `or` | log | -0.0015 [-0.0095, 0.0064] | ±0.0309 | Pass | 0.9500 [0.9343, 0.9630] | Pass | 1.0074 [0.9636, 1.0569] | Pass | Pass |

#### Continuous outcome law

| implementation | estimand | scale | bias (99% CI) | bias margin | bias test | coverage (99% CI) | coverage test | SE ratio (99% CI) | SE test | overall |
| --- | --- | --- | ---: | ---: | --- | ---: | --- | ---: | --- | --- |
| cleverly | `ey1` | identity | 0.000264 [-0.000260, 0.000788] | ±0.0020 | Pass | 0.9519 [0.9364, 0.9646] | Pass | 1.0107 [0.9678, 1.0585] | Pass | Pass |
| cleverly | `ey0` | identity | 0.000298 [-0.000147, 0.000743] | ±0.0017 | Pass | 0.9531 [0.9378, 0.9657] | Pass | 1.0146 [0.9704, 1.0620] | Pass | Pass |
| cleverly | `ate` | identity | -0.000034 [-0.000459, 0.000392] | ±0.0017 | Pass | 0.9481 [0.9321, 0.9614] | Pass | 1.0015 [0.9570, 1.0522] | Pass | Pass |
| cleverly | `att` | identity | -0.000144 [-0.000602, 0.000314] | ±0.0018 | Pass | 0.9394 [0.9223, 0.9537] | Pass | 0.9706 [0.9267, 1.0189] | Pass | Pass |
| cleverly | `atc` | identity | 0.000054 [-0.000400, 0.000508] | ±0.0018 | Pass | 0.9463 [0.9300, 0.9597] | Pass | 0.9893 [0.9445, 1.0378] | Pass | Pass |
| cleverly | `ey_obs` | identity | 0.000272 [-0.000234, 0.000779] | ±0.0020 | Pass | 0.9506 [0.9350, 0.9635] | Pass | 0.9908 [0.9461, 1.0396] | Pass | Pass |
| cleverly | `par` | identity | -0.000026 [-0.000327, 0.000276] | ±0.0012 | Pass | 0.9344 [0.9168, 0.9493] | Pass | 0.9451 [0.9040, 0.9908] | Pass | Pass |
| tmle3 | `ey1` | identity | 0.000279 [-0.000244, 0.000802] | ±0.0020 | Pass | 0.9519 [0.9364, 0.9646] | Pass | 1.0122 [0.9691, 1.0589] | Pass | Pass |
| tmle3 | `ey0` | identity | 0.000298 [-0.000147, 0.000742] | ±0.0017 | Pass | 0.9537 [0.9385, 0.9662] | Pass | 1.0149 [0.9699, 1.0628] | Pass | Pass |
| tmle3 | `ate` | identity | -0.000018 [-0.000442, 0.000406] | ±0.0016 | Pass | 0.9500 [0.9343, 0.9630] | Pass | 1.0125 [0.9673, 1.0625] | Pass | Pass |
| tmle3 | `att` | identity | -0.000888 [-0.0013, -0.000431] | ±0.0018 | Pass | 0.9400 [0.9230, 0.9543] | Pass | 0.9726 [0.9300, 1.0202] | Pass | Pass |
| tmle3 | `atc` | identity | 0.000837 [0.000387, 0.0013] | ±0.0017 | Pass | 0.9475 [0.9314, 0.9608] | Pass | 0.9957 [0.9522, 1.0444] | Pass | Pass |
| tmle3 | `ey_obs` | identity | 0.000272 [-0.000234, 0.000779] | ±0.0020 | Pass | 0.9506 [0.9350, 0.9635] | Pass | 0.9908 [0.9474, 1.0386] | Pass | Pass |
| tmle3 | `par` | identity | -0.000024 [-0.000325, 0.000277] | ±0.0012 | Pass | 0.9375 [0.9203, 0.9521] | Pass | 0.9526 [0.9107, 0.9970] | Pass | Pass |
...
| --- | ---: | ---: | --- | ---: | --- | ---: | --- | ---: | --- | --- |
| `ey1` | -0.000000 [-0.000000, 0.000000] | ±0.0034 | Pass | 1.0000 (1.0000) | Pass | 0 (0) | Pass | 0 (0.000039) | Pass | Pass |
| `ey0` | 0.000000 [-0.000000, 0.000000] | ±0.0032 | Pass | 1.0000 (1.0000) | Pass | 0 (0) | Pass | 0.000040 (0.000049) | Pass | Pass |
| `ate` | -0.000001 [-0.000004, 0.000003] | ±0.0044 | Pass | 0.9999 (1.0000) | Pass | 0.000625 (0) | Pass | 0.000032 (0.000128) | Pass | Pass |
| `att` | -0.000022 [-0.000070, 0.000026] | ±0.0046 | Pass | 1.0054 (1.0067) | Pass | 0.000625 (-0.0031) | Pass | 0 (0.0061) | Pass | Pass |
| `atc` | 0.000023 [-0.000025, 0.000071] | ±0.0046 | Pass | 1.0052 (1.0066) | Pass | -0.0037 (-0.0081) | Pass | 0 (0.0061) | Pass | Pass |
...
| estimand | paired difference (99% CI) | similarity margin | similarity | RMSE ratio (99% upper) | RMSE NI | coverage difference (99% lower) | coverage NI | calibration excess (99% upper) | calibration NI | overall |
| --- | ---: | ---: | --- | ---: | --- | ---: | --- | ---: | --- | --- |
| `ey1` | -0.000015 [-0.000029, -0.000001] | ±0.0012 | Pass | 1.0017 (1.0032) | Pass | 0 (-0.0019) | Pass | 0 (0.0025) | Pass | Pass |
| `ey0` | -0.000000 [-0.000013, 0.000013] | ±0.0010 | Pass | 1.0013 (1.0030) | Pass | -0.000625 (-0.0025) | Pass | 0 (0.0015) | Pass | Pass |
| `ate` | -0.000016 [-0.000039, 0.000008] | ±0.000989 | Pass | 1.0030 (1.0062) | Pass | -0.0019 (-0.0063) | Pass | 0 (0.0129) | Pass | Pass |
| `att` | 0.000744 [0.000717, 0.000772] | ±0.0011 | Pass | 0.9948 (1.0019) | Pass | -0.000625 (-0.0069) | Pass | 0.0021 (0.0054) | Pass | Pass |
| `atc` | -0.000783 [-0.000814, -0.000751] | ±0.0011 | Pass | 1.0009 (1.0088) | Pass | -0.0012 (-0.0081) | Pass | 0.0064 (0.0098) | Pass | Pass |
...
| --- | --- | --- | ---: | ---: | --- | --- | --- | --- |
| Double robustness | `both_correct` | positive | 700 | 1,200 | bias -0.0034 | bias CI [-0.0104, 0.0037] | 99% bias CI inside ±0.0236 | Pass |
| Double robustness | `outcome_correct` | positive | 700 | 1,200 | bias 0.000306 | bias CI [-0.0062, 0.0069] | 99% bias CI inside ±0.0220 | Pass |
| Double robustness | `treatment_correct` | positive | 700 | 1,200 | bias -0.0182 | bias CI [-0.0292, -0.0072] | 99% bias CI inside ±0.0369 | Pass |
| Double robustness | `both_wrong` | control | 700 | 1,200 | bias -0.3332 | bias CI [-0.3420, -0.3244] | 99% bias CI outside ±0.0295 | Pass (control broke as required) |
| Root-n and efficiency | `n_500` | positive | 500 | 800 | bias -0.000770; coverage 0.9463; SE ratio 0.9913 | bias CI [-0.0091, 0.0076]; coverage CI [0.9223, 0.9647] | bias equivalent; coverage lower ≥ 0.9000; SE ratio in [0.8000, 1.2000] | Pass |
| Root-n and efficiency | `n_2000` | positive | 2,000 | 800 | bias -0.000513; coverage 0.9437; SE ratio 0.9777 | bias CI [-0.0048, 0.0037]; coverage CI [0.9194, 0.9627] | bias equivalent; coverage lower ≥ 0.9000; SE ratio in [0.8000, 1.2000] | Pass |
| Root-n and efficiency | `n_8000` | positive | 8,000 | 800 | bias 0.000285; coverage 0.9525; SE ratio 1.0077 | bias CI [-0.0018, 0.0023]; coverage CI [0.9297, 0.9698] | bias equivalent; coverage lower ≥ 0.9000; SE ratio in [0.8000, 1.2000] | Pass |
| Root-n rate | `empirical_sd` | positive | 500 / 2,000 / 8,000 | 800 each | slope -0.5045 | slope CI [-0.5374, -0.4725] | 99% slope CI inside [-0.6250, -0.3750] and excluding -0.2500 | Pass |
| Root-n rate | `reported_se` | positive | 500 / 2,000 / 8,000 | 800 each | slope -0.4986 | slope CI [-0.4998, -0.4974] | 99% slope CI inside [-0.6250, -0.3750] and excluding -0.2500 | Pass |
| Interval calibration | `correctly_specified` | positive | 2,000 | 2,400 | coverage 0.9542; SE ratio 1.0027 | coverage CI [0.9420, 0.9645]; SE-ratio CI [0.9679, 1.0385] | coverage CI in [0.9200, 0.9800]; SE-ratio CI in [0.9300, 1.0700] | Pass |
