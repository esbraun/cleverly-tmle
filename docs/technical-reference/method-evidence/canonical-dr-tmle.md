...
The committed history separates the budget from the environment. The first 800 replications of
each rung ran under both environments, and their estimates agree within 7.3e-5. At that budget
the slope rule gives each interval within 2e-5 under both environments, and
