...
The ledger reads verdict rows only. It does not read the fit-health audits that the two DR-TMLE
studies publish as counts.

## Who owns each red row

Each owner is an `id` in the "What this row asks for" table of
...
| --- | --- | --- |
| [`F18`](../../roadmap.md#f18-selector-path-c-tmle-inference) | 10 | selector-based point-treatment C-TMLE, selector-based multi-arm C-TMLE |
| [`F19`](../../roadmap.md#f19-outcome-adaptive-c-tmle-generated-design-inference) | 2 | outcome-adaptive multi-arm C-TMLE |
| [`RM18-fixed-weights`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) | 2 | cross-fitted weighted end-of-study longitudinal TMLE |
| [`RM18-one-sided-bias`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) | 3 | DR-TMLE for binary complete data, multi-arm point-treatment DR-TMLE |
| [`RM18-slopes`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) | 2 | multi-arm point-treatment DR-TMLE |
| [`RM18-ordinary-weighted`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) | 6 | ordinary weighted end-of-study longitudinal TMLE |
| [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) | 7 | DR-TMLE for binary complete data, multi-arm point-treatment DR-TMLE, cross-fitted weighted end-of-study longitudinal TMLE |
| [`RM18-comparator-density`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) | 1 | ordinary continuous modified treatment policies |
| total | 33 | 8 studies |
<!-- /generated -->
...
| [selector-based multi-arm C-TMLE](selector-based-multi-arm-c-tmle.md) | property | `root_n_and_efficiency/n_500` | positive | its own rule | bias 0.0010, coverage 0.8965 to 0.9627, SE ratio 0.9892 | [`F18`](../../roadmap.md#f18-selector-path-c-tmle-inference) |
...
| [DR-TMLE for binary complete data](canonical-dr-tmle.md) | property | `double_robust_contraction/treatment_correct_n1500` | positive | its own rule | coverage 0.8864 to 0.9385, bias 0.0115 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [DR-TMLE for binary complete data](canonical-dr-tmle.md) | property | `double_robustness/outcome_correct` | positive | its own rule | bias 0.0026 to 0.0075, margin 0.0067, SE ratio 0.9888 | [`RM18-one-sided-bias`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [DR-TMLE for binary complete data](canonical-dr-tmle.md) | property | `double_robustness/treatment_correct` | positive | its own rule | bias 0.0068 to 0.0121, margin 0.0072, SE ratio 0.9671 | [`RM18-one-sided-bias`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [multi-arm point-treatment DR-TMLE](multi-arm-dr-tmle.md) | property | `double_robust_contraction/outcome_correct_n4000` | positive | its own rule | coverage 0.8988 to 0.9542, bias 0.000900 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [multi-arm point-treatment DR-TMLE](multi-arm-dr-tmle.md) | property | `double_robust_contraction/rate_outcome_correct` | positive | its own rule | slope -1.2342 to 3.7735 | [`RM18-slopes`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [multi-arm point-treatment DR-TMLE](multi-arm-dr-tmle.md) | property | `double_robust_contraction/rate_treatment_correct` | positive | its own rule | slope -3.2412 to 3.3387 | [`RM18-slopes`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [multi-arm point-treatment DR-TMLE](multi-arm-dr-tmle.md) | property | `double_robustness/treatment_correct` | positive | its own rule | bias 0.0015 to 0.0072, margin 0.0068, SE ratio 0.9998 | [`RM18-one-sided-bias`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [multi-arm point-treatment DR-TMLE](multi-arm-dr-tmle.md) | property | `interval_calibration/correctly_specified` | positive | its own rule | coverage 0.9300 to 0.9597, SE ratio 0.9258 to 1.0123 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [multi-arm point-treatment DR-TMLE](multi-arm-dr-tmle.md) | property | `root_n_and_efficiency/n_500` | positive | its own rule | bias -0.000902, coverage 0.8965 to 0.9627, SE ratio 0.9888 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [ordinary continuous modified treatment policies](continuous-modified-treatment-policies.md) | paired | `continuous_modified_policy/ate_shift[+0.25 vs natural course]` | paired | inconclusive: calibration leg | difference 0.000061 to 0.000361 within 0.000770, RMSE ratio bound 1.0583 vs 1.1000, coverage difference bound -0.0063 vs -0.0250, calibration excess bound 0.0659 vs 0.0500, resolution 0.0450 | [`RM18-comparator-density`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
...
| [ordinary weighted end-of-study longitudinal TMLE](ordinary-weighted-end-of-study-longitudinal-tmle.md) | property | `targeting_necessity/dynamic__targeted` | positive | the family's joint clause | bias -0.0025 to 0.0019, margin 0.0075 | [`RM18-ordinary-weighted`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [ordinary weighted end-of-study longitudinal TMLE](ordinary-weighted-end-of-study-longitudinal-tmle.md) | property | `targeting_necessity/dynamic__untargeted` | control | the family's joint clause | bias 0.0229 to 0.0284, margin 0.0093 | [`RM18-ordinary-weighted`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [ordinary weighted end-of-study longitudinal TMLE](ordinary-weighted-end-of-study-longitudinal-tmle.md) | property | `targeting_necessity/static__targeted` | positive | the family's joint clause | bias -0.0027 to 0.0075, margin 0.0172 | [`RM18-ordinary-weighted`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [ordinary weighted end-of-study longitudinal TMLE](ordinary-weighted-end-of-study-longitudinal-tmle.md) | property | `targeting_necessity/static__untargeted` | control | its own rule | bias -0.0242 to -0.0148, margin 0.0158 | [`RM18-ordinary-weighted`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [ordinary weighted end-of-study longitudinal TMLE](ordinary-weighted-end-of-study-longitudinal-tmle.md) | property | `type_i_error/static__sharp_null` | positive | its own rule | rejection 0.0750, 0.0530 to 0.1022 | [`RM18-ordinary-weighted`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [cross-fitted weighted end-of-study longitudinal TMLE](cross-fitted-weighted-end-of-study-longitudinal-tmle.md) | paired | `selected_censored_end_of_study/ey_regimen[always]` | paired | underpowered: coverage leg, calibration leg, calibration resolution | difference -0.000150 to 0.000202 within 0.0031, RMSE ratio bound 1.0162 vs 1.1000, coverage difference bound -0.0475 vs -0.0250, calibration excess bound 0.1050 vs 0.0500, resolution 0.1121 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [cross-fitted weighted end-of-study longitudinal TMLE](cross-fitted-weighted-end-of-study-longitudinal-tmle.md) | paired | `selected_censored_end_of_study/ey_regimen[never]` | paired | underpowered: coverage leg, calibration resolution | difference -0.000350 to 0.000263 within 0.0047, RMSE ratio bound 1.0245 vs 1.1000, coverage difference bound -0.0300 vs -0.0250, calibration excess bound 0.0465 vs 0.0500, resolution 0.0662 | [`RM18-fixed-weights`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [cross-fitted weighted end-of-study longitudinal TMLE](cross-fitted-weighted-end-of-study-longitudinal-tmle.md) | paired | `selected_censored_end_of_study/ey_regimen[treat then continue if l2 positive]` | paired | underpowered: coverage leg, calibration resolution | difference -0.000118 to 0.000400 within 0.0032, RMSE ratio bound 1.0175 vs 1.1000, coverage difference bound -0.0425 vs -0.0250, calibration excess bound 0.0382 vs 0.0500, resolution 0.1119 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [cross-fitted weighted end-of-study longitudinal TMLE](cross-fitted-weighted-end-of-study-longitudinal-tmle.md) | property | `double_robustness/static__both_wrong` | control | its own rule | bias -0.0251 to -0.0151, margin 0.0167, SE ratio 0.6640 | [`RM18-boundary`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
| [cross-fitted weighted end-of-study longitudinal TMLE](cross-fitted-weighted-end-of-study-longitudinal-tmle.md) | property | `interval_calibration/static__correctly_specified` | positive | its own rule | coverage 0.9232 to 0.9492, SE ratio 0.9430 to 1.0203, empirical efficiency ratio 1.0195 to 1.1006, reported efficiency ratio 1.0333 to 1.0442 | [`RM18-fixed-weights`](../../roadmap.md#rm18-red-property-cells-after-the-fold-scale-and-law-changes) |
<!-- /generated -->
