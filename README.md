...
That is a different parameter rather than a setting, and `eliminate=` is refused by name
saying so. Neither is a cause-specific hazard ratio, and neither is a Fine–Gray
