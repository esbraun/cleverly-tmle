...
not. The registered ``repeat_stability`` property now covers repeated fold draws. It compares
one and three draws across 400 paired fold seeds on one fixed binary sample.
