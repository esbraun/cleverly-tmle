...
| `tests/canonical/lmtp_crossfit_adapter.R` | `788af2d43a3489597231e271769eca5d2b0b15e786be8482233819fe0e023a00` | `9ec0c76f9ed1ee41276b73071d51baaacae8537662e2f61994ac49cc4493b71f` | result-neutral: every existing study uses five labels, so the adapter still defines each training set as the complement of its validation set. The new branch applies only to a one-label assignment, which no recorded manifest used |
