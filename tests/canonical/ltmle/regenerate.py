"""Regenerate the paired cleverly/R ltmle study and independent property artifacts."""
...
from tests.studies.ltmle_properties import generate_property_rows, summarize_properties
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="cleverly-ltmle-") as raw:
    ...
    write_manifest(
        ...
        reference_files=[HERE / "Dockerfile", HERE / "run_study.R", HERE / "generate_reference.R"],
