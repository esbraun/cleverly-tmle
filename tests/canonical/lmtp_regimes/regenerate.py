"""Regenerate deterministic-regime evidence."""

from pathlib import Path

from tests.canonical.regenerate import Reference, main
from tests.studies import canonical_deterministic_regimes, deterministic_regime_properties
from tests.studies.evidence.registry import ROOT

REFERENCE = Reference(
    image="cleverly-lmtp-crossfit:1.5.4",
    runner="lmtp_regimes/run_study.R",
    mount_runner=True,
...
if __name__ == "__main__":
    main(
        ...
        deterministic_regime_properties,
