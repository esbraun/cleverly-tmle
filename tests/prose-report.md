...
| `docs/technical-reference/evidence.md` | paragraph-length | `5b6e64bdc3c6` | 9 sentences: The randomized missing-outcome DR-TMLE surfa... | accepted: one evidence chain from source to witness to end-to-end fit; a split separates a claim from its witness |
| `docs/technical-reference/method-evidence.md` | paragraph-length | `a026a7806434` | 7 sentences: A Monte Carlo study accumulates evidence by... | accepted: seven short sentences building one argument about significance tests; merging any two hides a step |
