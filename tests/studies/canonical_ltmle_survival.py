"""Canonical ordinary survival-curve longitudinal TMLE evidence study.

The paired comparison gives cleverly and R ``ltmle`` the same realized censored
...
STUDY = StudyRecord(
    name="ordinary survival-curve longitudinal TMLE",
    slug="canonical-ltmle-survival",
    artifacts=ROOT / "tests" / "canonical" / "ltmle_survival",
    document="docs/technical-reference/method-evidence/ordinary-survival-curve-longitudinal-tmle.md",
    anchor="ordinary-survival-curve-longitudinal-tmle",
...
def _replicate(
    ...
    return sample, truths_rows, cleverly_rows(frame, truth, scenario, replicate)
